  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ fontSize: '1.75rem', fontWeight: '800', color: '#1e3a8a', marginTop: '4px' }}>{data?.totalClicks ?? 0}</div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
        ...
        <div style={{ border: '1px solid #f1f5f9', padding: '16px', borderRadius: '8px', backgroundColor: '#fafafa' }}>
          ...
          {!data?.deviceBreakdown || Object.entries(data.deviceBreakdown).length === 0 ? <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Pending logs...</p> : 
        ...
        <div style={{ border: '1px solid #f1f5f9', padding: '16px', borderRadius: '8px', backgroundColor: '#fafafa' }}>
          ...
          {!data?.referrerBreakdown || Object.entries(data.referrerBreakdown).length === 0 ? <p style={{ color: '#94a3b8', fontSize: '0.9rem' }}>Pending logs...</p> : 
